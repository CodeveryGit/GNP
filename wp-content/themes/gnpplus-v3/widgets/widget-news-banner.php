...
class WT_News_Banner extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'wt-news-banner';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'News Banner Block', $this->get_widget_slug() ),
			array(
	...
	public function widget( $args, $instance ) {
		...
		/**************************************************************
                ...
                ***************************************************************/
                ...
                $variation["type"] = "masonry-news-item";
...
add_action( 'widgets_init', create_function( '', 'register_widget("WT_News_Banner");' ) );
