...
class WT_News extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'News Block', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'Show a news block.', $this->get_widget_slug() )
			)
		);
...
add_action( 'widgets_init', create_function( '', 'register_widget("WT_News");' ) );
