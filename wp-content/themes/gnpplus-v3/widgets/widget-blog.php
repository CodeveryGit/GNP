...
class WT_Blog extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'Blog Block', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'Show a blog block.', $this->get_widget_slug() )
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		/**************************************************************
                ...
                ***************************************************************/
                ...
                {
                    wbb_get_component( "comp-media-item-large" , $variation);
                }
                else if( $variation["size"] === "small" )
                {
                    wbb_get_component( "comp-media-item-small" , $variation);
                }
...
add_action( 'widgets_init', create_function( '', 'register_widget("WT_Blog");' ) );
