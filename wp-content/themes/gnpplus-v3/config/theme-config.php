...
// IMAGES SIZES
add_image_size ( 'resource-frontend' , 221 , 331 , true );
add_image_size ( 'small-block-frontend' , 252 , 192 , true );
add_image_size ( 'large-block-frontend' , 527 , 407 , true );
add_image_size ( 'carousel-frontend' , 1200 , 400 , true );
